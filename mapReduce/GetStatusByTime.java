...
public class GetStatusByTime {
    ...
    public static class Map extends MapReduceBase implements Mapper<LongWritable,Text, Text, Text> {
        ...
        //设置startTime  endTime
			...
			s.set(2011,06,11,00,00,00);
			startTime = inputFormat.format(s.getTime());
     	    Calendar c=Calendar.getInstance(); 
			c.set(2011,06,17,00,00,00);
        ...
        public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
        	//输出：key-微博MID  value-微博内容
                ...
                if(value.toString().startsWith("["))
                {
                    statusList = Status.constructStatuses(Tool.removeEol(value.toString()));		//Tool.removeEol() 清除文本中的"\r\n"
                }
    ...
    public static void main(String[] args) throws Exception {
        ...
        JobConf conf = new JobConf(GetStatusByTime.class);
